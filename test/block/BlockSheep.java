...
public class BlockSheep extends Block
{
    ...
    {
        return par2 == 1 ? Block.wood.getBlockTextureFromSide(par1) : (par2 == 2 ? Block.wood.getBlockTextureFromSide(par1) : Block.wood.getBlockTextureFromSide(par1));
    }
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            ...
            entitysheep.setLocationAndAngles((double)par2 + 0.5D, (double)par3, (double)par4 + 0.5D, 0.0F, 0.0F);
    ...
    {
        return par0 == Block.wood.blockID || par0 == Block.wood.blockID || par0 == Block.wood.blockID;
    }
    ...
    {
        return par0 == Block.wood.blockID ? 1 : (par0 == Block.wood.blockID ? 2 : 0);
    }
